...
public class PalindromeDetectorTest {
	...
	@Test
	public void testIsPalindrome_true_noSpecialChar2() {
		assertTrue(PalindromeDetector.isPalindrome("racecar"));
	}

	@Test
	public void testIsPalindrome_false_noSpecialChar() {
		assertFalse(PalindromeDetector.isPalindrome("racercar"));
	}
